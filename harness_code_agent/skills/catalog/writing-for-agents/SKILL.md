...
When the document you're writing is a skill, load `catalog/writing-for-agents/SKILL-MECHANICS.md` with `read_skill_file` for frontmatter, invocation choice, and router skills.
...
- **By invocation**, skill-specific: load `catalog/writing-for-agents/SKILL-MECHANICS.md`.
