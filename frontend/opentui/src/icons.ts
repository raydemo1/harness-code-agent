...
export type IconName = "prompt" | "assistant" | "session" | "newSession" | "search" | "tool" | "file" | "success" | "failure" | "pending" | "running" | "warning" | "approval" | "question" | "profile" | "checkpoint" | "observe" | "close";
...
export const unicodeIcons: IconSet = {
  ...
  success: "✓", failure: "×", pending: "○", running: "›", warning: "!", approval: "!", question: "?",
...
export const nerdIcons: IconSet = {
  ...
  success: "󰄬", failure: "󰅖", pending: "󰔟", running: "󰁕", warning: "󰀪", approval: "󰌶", question: "󰘥",
