...
export const themes: Record<ThemeMode, Theme> = {
  dark: {
    ...
    diffAdd: "#7fd39a", diffDelete: "#ec9090", diffAddBackground: "#193524", diffDeleteBackground: "#3a2024",
  },
  light: {
    ...
    diffAdd: "#257a44", diffDelete: "#b23d3d", diffAddBackground: "#dff1e5", diffDeleteBackground: "#f5e1e1",
  },
};
